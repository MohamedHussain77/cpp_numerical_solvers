...
class Diffusion : public Solver{ 
    ...
    public:
        Diffusion( const Mesh& mesh_param, Field_u& u_param, double nu_param, double r_param, double totaltime_param, NumericalMethod& method_param, TimeStepper& stepper_,
